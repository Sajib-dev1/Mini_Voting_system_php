    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="../voter/dashboard.php" class="brand-logo">
                <img class="logo-abbr" src="../image/logo_voter.png" alt="">
                <h2 class="strong text-primary">USER</h2>
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<?php
                                $warning_status = $after_ascos_voter_name['deleted_at'];

                                if($warning_status == '2020-03-20 11:22:29'){
                                    ?>
									
									
                                    <h4 class="alert alert-warning text-dark"><span style="font-size: 30px;">&#9888;</span> Correct your personal information or <a href="election_commitional.php" class="text-info" style="text-decoration: underline;">contact the Election Comitional</a></h4>
                                    <?php
                                }
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<div class="copyright">
					<p><strong>Election User Dashboard</strong> © <?php echo date('Y')?> All Rights Reserved</p>
